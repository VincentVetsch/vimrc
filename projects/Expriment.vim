...
badd +0 ~/Documents/Notes/Experiment.note
silent! argdel *
edit ~/Documents/Notes/Experiment.note
...
exe 'vert 1resize ' . ((&columns * 97 + 108) / 216)
exe 'vert 2resize ' . ((&columns * 118 + 108) / 216)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
let s:l = 1116 - ((1115 * winheight(0) + 27) / 54)
