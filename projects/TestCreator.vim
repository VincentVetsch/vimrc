...
silent only
cd ~/Projects/TestCreator/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +9 ~/Projects/TestCreator/src/TestCreator.py
args TestCreator.py
edit ~/Projects/TestCreator/src/TestCreator.py
...
exe 'vert 1resize ' . ((&columns * 94 + 66) / 133)
exe 'vert 2resize ' . ((&columns * 38 + 66) / 133)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
argglobal
enew
file ~/Projects/TestCreator/src/__Tagbar__
setlocal keymap=
setlocal noarabic
setlocal autoindent
